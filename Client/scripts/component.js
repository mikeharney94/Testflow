class Component{
	...
	isComponentDifferent(com2){
		return !(this.id == com2.id &&
			this.name == com2.name &&
			this.type == com2.type &&
			this.content == com2.content &&
			this.answer == com2.answer &&
			this.weight == com2.weight &&
			this.x == com2.x &&
			this.y == com2.y);
	}
	static fieldToComponent(card){
		switch(card.type){
			case 'multipleChoice':
	...
	static componentToField(component){
